...
// func ProcessSubmitItem(item types.BundleItem, currency string, isNoFeeMode bool, apiKey string, isSort bool, size int64) (schema.Order, error) {
...
// func CalcItemFee(currency string, itemSize int64) (*schema.RespFee, error) {
...
// func GetBundlePerFees() (map[string]schema.Fee, error) {
...
// func ParseAndSaveBundleItems(arId string, data []byte) error {
...
// func saveItem(item types.BundleItem) error {
...
// func DelItem(itemId string) error {
